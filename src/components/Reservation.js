                                ...
                                <Row>
                                    ...
                                    {/* <!-- Date --> */}
                                            ...
                                            <span className="txt9">
                                                ...
                                                <FormSelect className="select2 sizefull txt10 p-l-20"  name="time" value={newOrder.time} onChange={handleChange} required >
                                            ...
                                            <div className="wrap-inputpeople size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                                {/* <!-- Select2 --> */}
                                                <FormSelect className="select2 sizefull txt10 p-l-20" name="partySize" value={newOrder.partySize} onChange={handleChange} required >
                                            ...
                                            <div className="wrap-inputtable select2 size12 bo2 bo-rad-10 m-t-3 m-b-23">
                                                {/* <!-- Select2 --> */}
                                                <FormSelect className="select2 sizefull txt10 p-l-20" name="table" placeholder='Choose Your Table' value={newOrder.table} onChange={handleChange}>
                                    ...
                                    <Col className="col-md-6">
                                            ...
                                            <div className="wrap-inputname select2 size12 bo2 bo-rad-10 m-t-3 m-b-23">
